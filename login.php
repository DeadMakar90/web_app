...
$sql = "SELECT * FROM `USERS` WHERE `LOGIN` = '$usr' AND `PASSWD` = '$pass' AND `FLAG` != 0"; //Запрос к базе данных
...
if(isset($_SESSION['username'])){  //если переменная $_SESSION не пустая, т
	...
	header('Location: admins_form.php'); //перебрасываем на следующуюю страницу
}
?>
